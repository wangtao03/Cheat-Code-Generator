...
namespace Keystone
{
    ...
    public sealed class Engine : IDisposable
    {
        ...
        /// <summary>
        /// Gets or sets a value that represents whether a <see cref="KeystoneException"/> should be
        /// thrown on error.
        /// </summary>
        ...
        /// <remarks>
        /// Some architectures are not supported. Check with <see
        /// cref="IsArchitectureSupported(Architecture)"/> if the engine supports the target architecture.
        /// </remarks>
        public Engine(Architecture architecture, Mode mode)
        {
            var path = Path.GetDirectoryName(Assembly.GetEntryAssembly().Location);
            path = Path.Combine(path, Environment.Is64BitProcess ? "x64" : "x86");
            NativeInterop.SetDllDirectory(path);
        ...
        /// <returns>
        /// Result of the operation, or <c>null</c> if it failed and <see cref="ThrowOnError"/> is <c>false</c>.
        /// </returns>
        ...
        /// <param name="statementCount">Number of statements found and encoded.</param>
        /// <returns>
        /// Size of the data writen by the operation., or <c>0</c> if it failed and <see
        /// cref="ThrowOnError"/> is <c>false</c>.
        /// </returns>
        /// <exception cref="ArgumentNullException">A null argument was given.</exception>
        ...
        /// <param name="statementCount">Number of statements found and encoded.</param>
        /// <returns>
        /// <c>true</c> on success, or <c>false</c> if it failed and <see cref="ThrowOnError"/> is <c>false</c>.
        /// </returns>
        /// <exception cref="ArgumentNullException">A null argument was given.</exception>
        /// <exception cref="KeystoneException">An error encountered when encoding the instructions.</exception>
        ...
        /// <remarks>It might not retain its old error once accessed.</remarks>
