...
namespace Keystone
{
    ...
    internal class NativeInterop
    {
        ...
        // </summary>
        // static NativeInterop() { var myPath = new
        // Uri(typeof(NativeInterop).Assembly.CodeBase).LocalPath; var myFolder = Path.GetDirectoryName(myPath);

        // var is64 = IntPtr.Size == 8; var subfolder = is64 ? "\\win64\\" : "\\win32\\";

        // string dllPosition = myFolder + subfolder + "keystone.dll";

        // // If this file exist, load it. // Otherwise let the marshaller load the appropriate
        // file. if (File.Exists(dllPosition)) LoadLibrary(dllPosition); }
