...
namespace FastColoredTextBoxNS
{
    ...
    public class Range : IEnumerable<Place>
    {
        ...
        /// FastColoredTextBox.Selection range. So, if you want to set text, you need to use
        /// FastColoredTextBox.Selection and FastColoredTextBox.InsertText() mehtod.
        /// </remarks>
        ...
        /// <summary>
        /// Finds ranges for given regex pattern. Search is separately in each line. This method
        /// requires less memory than GetRanges().
        /// </summary>
        /// <param name="regexPattern">Regex pattern</param>
        /// <param name="options"></param>
        /// <returns>Enumeration of ranges</returns>
        ...
        /// <summary>
        /// Finds ranges for given regex. Search is separately in each line. This method requires
        /// less memory than GetRanges().
        /// </summary>
        ...
        /// <summary>
        /// Finds ranges for given regex pattern. Search is separately in each line (order of lines
        /// is reversed). This method requires less memory than GetRanges().
        /// </summary>
        /// <param name="regexPattern">Regex pattern</param>
        /// <param name="options"></param>
        /// <returns>Enumeration of ranges</returns>
        ...
        /// <summary>
        /// Range is readonly? This property return True if any char of the range contains
        /// ReadOnlyStyle. Set this property to True/False to mark chars of the range as Readonly/Writable.
        /// </summary>
