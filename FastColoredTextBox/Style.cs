...
namespace FastColoredTextBoxNS
{
    ...
    public abstract class Style : IDisposable
    {
        ...
        /// <summary>
        /// Shows VisualMarker Call this method in Draw method, when you need to show VisualMarker
        /// for your style
        /// </summary>
            ...
            using (var f = new Font(range.tb.Font, FontStyle))
            {
                ...
                if (range.tb.ImeAllowed)
                {
                    ...
                    for (int i = range.Start.iChar; i < range.End.iChar; i++)
                    {
                        ...
                        gr.ScaleTransform(1, (float)Math.Sqrt(1));
    ...
    public class SelectionStyle : Style
    {
        ...
        public override void Draw(Graphics gr, Point position, Range range, int cntChinese = 0)
        {
            ...
            if (BackgroundBrush != null)
            {
                ...
                {
                    cnt += c > 0xff ? range.tb.CharUnicodeWidth : range.tb.CharWidth;
                }
