...
namespace FastColoredTextBoxNS
{
    public class SyntaxHighlighter : IDisposable
    {
        ...
        /// <summary>
        /// given XML description file
        /// </summary>
        /// <param name="XMLdescriptionFile"></param>
        /// <returns></returns>
        public virtual SyntaxDescriptor LoadXMLdescriptionFile(string XMLdescriptionFile)
        {
        ...
        public virtual void HighlightSyntax(string XMLdescriptionFile, Range range)
        {
            ...
            {
                desc = LoadXMLdescriptionFile(XMLdescriptionFile);
            }
        ...
        /// <summary>
        /// Uses the given <paramref name="doc"/> to parse a XML description and adds it as syntax
        /// descriptor. The syntax descriptor is used for highlighting when
        /// <list type="bullet">
        /// <item>Language property of FCTB is set to <see cref="Language.Custom"/></item>
        /// <item>
        /// DescriptionFile property of FCTB has the same value as the method parameter <paramref name="descriptionFileName"/>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <summary>
        /// Adds the given <paramref name="style"/> as resilient style. A resilient style is
        /// additionally available when highlighting is based on a syntax descriptor that has been
        /// derived from a XML description file. In the run of the highlighting routine the styles
        /// used by the FCTB are always dropped and replaced with the (initial) ones from the syntax
        /// descriptor. Resilient styles are added afterwards and can be used anyway.
        /// </summary>
